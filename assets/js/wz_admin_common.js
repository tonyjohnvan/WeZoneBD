...
// 1. Init common functions on document ready
    ...
    $(function() {
        ...
        wezone_helpers.truncate_text($('.truncate-text'));

        // full screen
        wezone_helpers.full_screen();
    });
    ...
    altair_page_onload = {
        init: function() {
            $window.load(function(){
                ...
                wezone_helpers.hierarchical_show();
                wezone_helpers.hierarchical_slide();
            });
        }
    };
        ...
        init: function() {
            if($sidebar_main.length) {
                ...
                if (!$body.hasClass('sidebar_mini') && localStorage.getItem("altair_sidebar_mini") === null) {
                    ...
                    // custom scroller
                    wezone_helpers.custom_scrollbar($sidebar_main);
    ...
    altair_secondary_sidebar = {
        init: function() {
            if($sidebar_secondary.length) {
                ...
                // custom scroller
                wezone_helpers.custom_scrollbar($sidebar_secondary);
    ...
    altair_md = {
        ...
        list_outside: function() {
            ...
            if($md_list_outside_wrapper && $body.hasClass('header_double_height')) {
                ...
                wezone_helpers.custom_scrollbar($md_list_outside_wrapper);
            }
        },

$(function() {
    // datatables
    wezone_datatables.dt_default();
    wezone_datatables.dt_scroll();
    wezone_datatables.dt_individual_search();
    wezone_datatables.dt_colVis();
    wezone_datatables.dt_tableTools();
});
